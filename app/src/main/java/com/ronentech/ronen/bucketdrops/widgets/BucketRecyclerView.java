package com.ronentech.ronen.bucketdrops.widgets;
...
import com.ronentech.ronen.bucketdrops.extras.Util;
...
public class BucketRecyclerView extends RecyclerView {
    ...
    private void toggleViews() {
        ...
        if(getAdapter() != null && !mNonEmptyViews.isEmpty() && !mNonEmptyViews.isEmpty()){
